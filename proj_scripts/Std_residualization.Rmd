...
fit_0.56 <- euler(c("X1" = tss_X1, "X2" = tss_X2, "Y" = tss_Y,
                  ...
                  shape = "ellipse")
corr_0.56 <- plot(fit_0.56, fills = c("lightblue", "lightgray", "darkblue"))
corr_0.56
...
tab_model(m1, m4, m3, show.se = T, collapse.se = T, digits = 3, show.ci = F, show.p = F, show.r2 = F, show.obs = F)
```


To drive this point home, here are the models refit to the first 100 subjects...
